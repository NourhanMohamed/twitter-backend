<?php 
	require_once "following_fetch.php";
...
<meta name="msapplication-TileColor" content="#00aced"/>
  ...
  <meta name="swift-page-name" id="swift-page-name" content="me">
    ...
    <link rel="canonical" href="https://twitter.com/bachelorprjct/following">
    ...
    <div class="account-group js-mini-current-user" data-user-id="2394399241" data-screen-name="bachelorprjct">
      ...
      <li class="js-signout-button" id="signout-button" data-nav="logout">
        ...
        <form class="dropdown-link-form signout-form" id="signout-form" action="/logout" method="POST">
          <input type="hidden" value="f5c2e0372b0c1ec4e6cdef1e39120a83c5dbf5b1" name="authenticity_token" class="authenticity_token">
...
<style id="user-style-bachelorprjct-bg-img" class="js-user-style-bg-img">
  ...
  <div role="navigation" class="module profile-nav">
    <ul class="js-nav-links">
      ...
      <li class="">
        <a class="list-link js-nav" href="favorites.php" data-nav="favorites">
...
<div class="webcam-detect swf-container"></div>
  ...
  <li><a class="js-nav" href="/following" data-element-term="following_stats" data-nav="following" data-is-compact="false">  Following<strong title="1" class="js-mini-profile-stat"><?php echo $followers;?></strong>
</a></li>
...
<button type="button" class="btn primary-btn done">Done</button>
  ...
  <div class="content-header">
    <div class="header-inner">
      <h2 id="content-main-heading" class="js-timeline-title">Following
      </h2>
...
foreach($arr["following"] as $follower)
{
	
 echo '
	<!-- to be repeated -->
	<li id="repeated_follower" class="js-stream-item stream-item stream-item 
" data-item-id="281018593" id="stream-item-user-281018593" data-item-type="user" style="">
<div class="account   js-actionable-user js-profile-popup-actionable " data-screen-name="',$follower['username'],'" data-user-id="281018593" data-feedback-token="" data-impression-id="">
<div class="user-actions btn-group following including  " data-user-id="281018593" data-screen-name="',$follower['username'],'" data-name="',$follower['name'],'" data-protected="false">
<div class="dropdown">
  ...
  <div class="dropdown-menu">
    ...
    <ul>
      <li class="mention-text pretty-link not-blocked"><button type="button" class="dropdown-link">Tweet to @',$follower['username'],'</button></li>
      ...
      <li class="block-text pretty-link not-blocked"><button type="button" class="dropdown-link">Block @',$follower['username'],'</button></li>
      <li class="unblock-text pretty-link"><button type="button" class="dropdown-link">Unblock @',$follower['username'],'</button></li>
      <li class="report-spam-text pretty-link"><button type="button" class="dropdown-link">Report @',$follower['username'],' for spam</button></li>
...
<div class="content">
    <div class="stream-item-header">
      <a class="account-group js-user-profile-link" href="/',$follower['username'],'">
        <img class="avatar js-action-profile-avatar " src="images/egg.png" alt="" data-user-id="281018593">
        <strong class="fullname js-action-profile-name">',$follower['name'],'</strong>
        <span>&rlm;</span>
        
          <span class="username js-action-profile-name">@',$follower['username'],'</span>
