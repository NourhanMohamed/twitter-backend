/*document.domain = "localhost";this line can be removed */
(function() {
    function a() {
        document.write = "";
...
(function(a, b) {
    ...
    function Gb(a, b) {
        ...
        if (i) {
            ...
            g.events = {};
            for (c in i)
                for (d = 0, e = i[c].length; d < e; d++) q.event.add(b, c, i[c][d])
        }
    ...
    function Gc(a, b) {
        ...
        if (g[1])
            for (c in a.converters) j[c.toLowerCase()] = a.converters[c];
        for (; e = g[++k];)
            if (e !== "*") {
                if (i !== "*" && i !== e) {
                    c =
    ...
    q.fn.extend({
        ...
        hasClass: function(a) {
            var b = " " + a + " ",
                ...
                d = this.length;
            for (; c < d; c++)
                if (this[c].nodeType === 1 && (" " + this[c].className + " ").replace(P, " ").indexOf(b) >= 0) return !0;
            return !1
        },
        val: function(a) {
            var c, d, e, f = this[0];
        ...
        find: function(a) {
            ...
            if (typeof a != "string") return q(a).filter(function() {
                for (b = 0, c = i.length; b < c; b++)
                    if (q.contains(i[b], this)) return !0
            });
        ...
        cleanData: function(a, b) {
            ...
            for (;
                ...
                if (b || q.acceptData(e)) {
                    ...
                    if (c) {
                        if (c.events)
                            for (f in c.events) l[f] ? q.event.remove(e, f) : q.removeEvent(e, f, c.handle);
                        if (j[d]) {
                            delete j[d];
            ...
            return {
                ...
                send: function(e, f) {
                    ...
                    c.username ? j.open(c.type, c.url, c.async, c.username, c.password) : j.open(c.type,
                        c.url, c.async);
                    if (c.xhrFields)
                        for (i in c.xhrFields) j[i] = c.xhrFields[i];
...
(function(a) {
    ...
    Array.prototype.every || (Array.prototype.every = function(b) {
        ...
        if (e(b) != "[object Function]") throw new TypeError(b + " is not a function");
        for (var g = 0; g < d; g++)
            if (g in c && !b.call(f, c[g], g, c)) return !1;
        return !0
    });
    Array.prototype.some || (Array.prototype.some = function(b) {
        ...
        if (e(b) != "[object Function]") throw new TypeError(b + " is not a function");
        for (var g = 0; g < d; g++)
            if (g in c && b.call(f, c[g], g, c)) return !0;
        return !1
    });
    Array.prototype
...
(function(a) {
    ...
    if (!Object.getOwnPropertyDescriptor) {
        ...
        Object.getOwnPropertyDescriptor = function(c, d) {
            if (typeof c != "object" && typeof c != "function" || c === null) throw new TypeError(a + c);
            if (!owns(c, d)) return;
            var e = {
                enumerable: !0,
                configurable: !0
...
(function(a, b) {
    ...
    function K() {
        for (var a in d)
            if (d[a].readyState == "interactive") return j[d[a].id]
    }
    ...
    z.prototype.complete = function() {
        ...
        if (!this.completed) {
            ...
            this.completed = !0;
            if (this.callbacks)
                for (var c = 0, d; d = this.callbacks[c]; c++) d.apply(a, this.results);
            if (b = n[this.key()]) {
...
(function(a, b) {
    ...
    a.Template.prototype = {
        ...
        d: function(a, b, d, e) {
            var f, g = a.split("."),
                i = this.f(g[0], b, d, e),
                j = this.options.modelGet,
                k = null;
            if (a === "." && n(b[b.length - 2])) i = b[b.length - 1];
            else
...
using.aliases = {
    "$jasmine.9f7999c33ed7c6f369e11e9973a7c0f85ca66084.js": ["test/core/clock_spec", "test/core/parameterize_spec", "test/fixtures/discover_stories", "test/fixtures/user_search", "test/fixtures/own_profile_header", "test/fixtures/trends_api", "test/fixtures/trends_location_dialog_api", "test/fixtures/advanced_search", "test/fixtures/settings_design_page", "test/fixtures/resend_password_help", "test/app/ui/with_conversation_actions_spec", "test/app/ui/discover_spec", "test/app/ui/promptbird_spec", "test/app/ui/password_spec", "test/app/ui/with_click_outside_spec", "test/app/ui/dynamic_card_watcher_spec", "test/app/ui/with_user_actions_spec", "test/app/ui/geo_picker_spec", "test/app/ui/dynamic_image_loader_spec", "test/app/ui/infinite_scroll_watcher_spec", "test/app/ui/with_tweet_activity_actions_spec", "test/app/ui/with_tweet_action_counts_spec", "test/app/ui/global_loading_indicator_spec", "test/app/ui/hidden_descendants_spec", "test/app/ui/timezone_detector_spec", "test/app/ui/password_dialog_spec", "test/app/ui/email_confirmation_spec", "test/app/ui/oauth_revoker_spec", "test/app/ui/related_tweets_spec", "test/app/ui/list_members_dashboard_spec", "test/app/ui/with_inline_image_editing_spec", "test/app/ui/search_input_spec", "test/app/ui/search_query_source_spec", "test/app/ui/temporary_password_button_spec", "test/app/ui/with_image_selection_spec", "test/app/ui/with_loading_indicator_spec", "test/app/ui/tweet_injector_spec", "test/app/ui/dashboard_tweetbox_spec", "test/app/ui/page_title_spec", "test/app/ui/with_tweet_actions_spec", "test/app/ui/design_spec", "test/app/ui/login_verification_confirmation_dialog_spec", "test/app/ui/with_interaction_data_spec", "test/app/ui/page_visibility_spec", "test/app/ui/dashboard_spec", "test/app/ui/drag_state_spec", "test/app/ui/inline_edit_spec", "test/app/ui/custom_timeline_follow_card_spec", "test/app/ui/global_nav_spec", "test/app/ui/direct_message_link_handler_spec", "test/app/ui/with_upload_photo_affordance_spec", "test/app/ui/field_edit_warning_spec", "test/app/ui/with_password_strength_spec", "test/app/ui/with_tweet_click_handler_spec", "test/app/ui/image_selector_spec", "test/app/ui/with_tweet_translation_spec", "test/app/ui/cookie_warning_spec", "test/app/ui/settings_controls_spec", "test/app/ui/protected_verified_dialog_spec", "test/app/ui/profile_edit_param_spec", "test/app/ui/with_redirect_after_follow_spec", "test/app/ui/with_focus_highlight_spec", "test/app/ui/with_topic_pivots_spec", "test/app/ui/with_position_spec", "test/app/ui/email_field_highlight_spec", "test/app/ui/user_dropdown_spec", "test/app/ui/multiline_ellipses_spec", "test/app/ui/image_uploader_spec", "test/app/ui/signup_call_out_spec", "test/app/ui/password_match_pair_spec", "test/app/ui/color_picker_spec", "test/app/ui/with_inline_image_options_spec", "test/app/ui/search_dropdown_spec", "test/app/ui/tweet_dialog_spec", "test/app/ui/suggested_users_spec", "test/app/ui/captcha_dialog_spec", "test/app/ui/with_viewer_follow_state_spec", "test/app/ui/theme_picker_spec", "test/app/ui/spoonbill_producer_spec", "test/app/ui/tweet_box_spec", "test/app/ui/aria_event_logger_spec", "test/app/ui/with_select_all_spec", "test/app/ui/validating_fieldset_spec", "test/app/ui/with_import_services_spec", "test/app/ui/edit_header_button_spec", "test/app/ui/alert_banner_to_message_drawer_spec", "test/app/ui/permalink_keyboard_support_spec", "test/app/ui/with_text_polling_spec", "test/app/ui/toolbar_spec", "test/app/ui/impression_cookies_spec", "test/app/ui/with_profile_stats_spec", "test/app/ui/hidden_ancestors_spec", "test/app/ui/with_dialog_spec", "test/app/ui/navigation_spec", "test/app/ui/user_completion_module_spec", "test/app/ui/advanced_search_spec", "test/app/ui/alert_banner_spec", "test/app/ui/with_stream_users_spec", "test/app/ui/with_dropdownmenu_spec", "test/app/ui/dm_envelope_spec", "test/app/ui/tooltips_spec", "test/app/ui/embed_stats_spec", "test/app/ui/geo_deletion_spec", "test/app/ui/new_tweet_button_spec", "test/app/ui/spoonbill_spec", "test/app/ui/prefilled_tweet_spec", "test/app/ui/with_forgot_password_spec", "test/app/ui/with_rtl_tweet_box_spec", "test/app/ui/login_verification_form_spec", "test/app/ui/capped_file_upload_spec", "test/app/ui/password_strength_spec", "test/app/ui/direct_message_media_preview_spec", "test/app/ui/who_to_tweet_spec", "test/app/ui/profile_hovercard_spec", "test/app/ui/profile_image_monitor_spec", "test/app/ui/direct_message_dialog_spec", "test/app/ui/profile_popup_spec", "test/app/ui/message_drawer_spec", "test/app/ui/deactivated_spec", "test/app/ui/inline_profile_editing_initializor_spec", "test/app/ui/with_rich_editor_spec", "test/app/ui/with_removable_stream_items_spec", "test/app/ui/theme_preview_spec", "test/app/ui/tweet_box_thumbnails_spec", "test/app/ui/direct_message_actions_spec", "test/app/ui/with_card_spec", "test/app/ui/list_follow_card_spec", "test/app/ui/with_item_actions_spec", "test/app/ui/with_timestamp_updating_spec", "test/app/ui/navigation_links_spec", "test/app/ui/with_hover_card_spec", "test/app/ui/search_actions_spec", "test/app/ui/with_tweetbox_initialization_spec", "test/app/ui/with_dropdown_spec", "test/app/ui/signin_dropdown_spec", "test/app/ui/inline_profile_editing_spec", "test/app/ui/connect_badge_spec", "test/app/ui/keyboard_shortcuts_spec", "test/app/helpers/describe_module_spec", "test/app/helpers/global_after_each_spec", "test/app/helpers/describe_component_with_data_components_spec", "test/app/helpers/test_scribing_component", "test/app/helpers/describe_mixin_spec", "test/app/helpers/second_data_component", "test/app/helpers/extra_jquery_helpers_spec", "test/app/helpers/describe_component_spec", "test/app/helpers/first_data_component", "test/app/helpers/log_client_events_spec", "test/app/helpers/test_component", "test/app/helpers/test_module", "test/app/helpers/ajax_respond_with_spec", "test/app/helpers/test_mixin", "test/app/data/media_thumbnails_scribe_spec", "test/app/data/with_interaction_data_scribe_spec", "test/app/data/promptbird_spec", "test/app/data/search_input_scribe_spec", "test/app/data/oembed_scribe_spec", "test/app/data/tweet_box_scribe_spec", "test/app/data/with_auth_token_spec", "test/app/data/signup_scribe_spec", "test/app/data/profile_popup_scribe_spec", "test/app/data/notification_listener_spec", "test/app/data/notifications_spec", "test/app/data/promoted_logger_spec", "test/app/data/lists_spec", "test/app/data/frontpage_scribe_spec", "test/app/data/gallery_scribe_spec", "test/app/data/who_to_follow_scribe_spec", "test/app/data/with_conversation_metadata_spec", "test/app/data/profile_card_scribe_spec", "test/app/data/related_tweets_spec", "test/app/data/list_members_dashboard_spec", "test/app/data/profile_canopy_scribe_spec", "test/app/data/permalink_scribe_spec", "test/app/data/login_scribe_spec", "test/app/data/search_assistance_scribe_spec", "test/app/data/temporary_password_spec", "test/app/data/item_actions_scribe_spec", "test/app/data/timeline_spec", "test/app/data/page_visibility_scribe_spec", "test/app/data/embed_stats_scribe_spec", "test/app/data/with_scribe_spec", "test/app/data/signup_click_scribe_spec", "test/app/data/contact_import_spec", "test/app/data/embed_scribe_spec", "test/app/data/typeahead_scribe_spec", "test/app/data/simple_event_scribe_spec", "test/app/data/user_completion_module_scribe_spec", "test/app/data/with_card_metadata_spec", "test/app/data/resend_password_help_scribe_spec", "test/app/data/topic_pivots_scribe_spec", "test/app/data/follower_request_spec", "test/app/data/scribing_context_spec", "test/app/data/with_widgets_spec", "test/app/data/user_actions_scribe_spec", "test/app/data/contact_import_scribe_spec", "test/app/data/activity_popup_spec", "test/app/data/suggested_users_spec", "test/app/data/tweet_spec", "test/app/data/with_data_spec", "test/app/data/signup_data_spec", "test/app/data/login_verification_spec", "test/app/data/resend_password_spec", "test/app/data/profile_social_proof_scribe_spec", "test/app/data/curation_spec", "test/app/data/user_spec", "test/app/data/settings_spec", "test/app/data/tweet_actions_scribe_spec", "test/app/data/trends_spec", "test/app/data/activity_popup_scribe_spec", "test/app/data/conversations_spec", "test/app/data/profile_alerts_scribe_spec", "test/app/data/navigation_spec", "test/app/data/direct_messages_scribe_spec", "test/app/data/who_to_follow_spec", "test/app/data/saved_searches_spec", "test/app/data/async_profile_spec", "test/app/data/spam_challenge_spec", "test/app/data/user_info_spec", "test/app/data/tweet_translation_spec", "test/app/data/tweet_activity_counts_scribe_spec", "test/app/data/saved_searches_scribe_spec", "test/app/data/prefilled_tweet_scribe_spec", "test/app/data/trends_scribe_spec", "test/app/data/oembed_spec", "test/app/data/who_to_tweet_spec", "test/app/data/inline_edit_scribe_spec", "test/app/data/email_banner_spec", "test/app/data/media_settings_spec", "test/app/data/honeypot_scribe_spec", "test/app/data/profile_popup_spec", "test/app/data/archive_navigator_scribe_spec", "test/app/data/report_tweet_scribe_spec", "test/app/data/ttft_navigation_spec", "test/app/data/interaction_timeline_actions_spec", "test/app/data/media_timeline_spec", "test/app/data/scriber_spec", "test/app/data/dm_poll_spec", "test/app/data/share_via_email_dialog_data_spec", "test/app/data/list_follow_card_spec", "test/app/data/users_spec", "test/app/data/geo_spec", "test/app/data/with_grid_timeline_data_spec", "test/app/data/direct_messages_spec", "test/app/data/form_scribe_spec", "test/app/data/profile_info_spec", "test/app/data/tweet_actions_spec", "test/app/utils/cookie_spec", "test/app/utils/with_session_spec", "test/app/utils/typeahead_helpers_spec", "test/app/utils/event_proxy_spec", "test/app/utils/drag_drop_helper_spec", "test/app/utils/auth_token_spec", "test/app/utils/with_keyboard_modality_spec", "test/app/utils/hide_or_show_divider_spec", "app/utils/multiline_text_range", "test/app/utils/multiline_text_range_spec", "test/app/utils/string_spec", "test/app/utils/setup_polling_with_backoff_spec", "test/app/utils/params_spec", "test/app/utils/querystring_spec", "test/app/utils/image_spec", "test/app/utils/html_text_spec", "test/app/utils/image_resize_spec", "test/app/utils/tweet_helper_spec", "test/app/utils/scale_animation_time_spec", "test/app/utils/request_logger_spec", "test/app/utils/image_thumbnail_spec", "test/app/utils/time_spec", "app/utils/blend_hex_color", "test/app/utils/blend_hex_color_spec", "test/app/utils/with_event_params_spec", "test/app/utils/oauth_popup_spec", "test/app/utils/chrome_spec", "test/app/ui/vit/verification_step_spec", "test/app/ui/vit/mobile_topbar_spec", "test/app/ui/signup/signup_form_spec", "test/app/ui/signup/with_captcha_spec", "test/app/ui/signup/with_signup_validation_spec", "test/app/ui/signup/stream_end_signup_module_spec", "test/app/ui/signup/suggestions_spec", "test/app/ui/banners/eu_cookie_spec", "test/app/ui/banners/email_banner_spec", "test/app/ui/trends/trends_dialog_spec", "test/app/ui/trends/trends_spec", "test/app/ui/expando/expando_helpers_spec", "test/app/ui/expando/expanding_tweets_spec", "test/app/ui/expando/with_expanding_containers_spec", "test/app/ui/expando/with_expanding_social_activity_spec", "test/app/ui/expando/close_all_button_spec", "test/app/ui/search/archive_navigator_spec", "test/app/ui/search/related_queries_spec", "test/app/ui/search/spelling_corrections_spec", "test/app/ui/typeahead/typeahead_dropdown_spec", "test/app/ui/typeahead/concierge_renderer_spec", "test/app/ui/typeahead/accounts_renderer_spec", "test/app/ui/typeahead/typeahead_input_spec", "test/app/ui/typeahead/recent_searches_renderer_spec", "test/app/ui/typeahead/trend_locations_renderer_spec", "test/app/ui/typeahead/topics_renderer_spec", "test/app/ui/typeahead/context_helpers_renderer_spec", "test/app/ui/typeahead/saved_searches_renderer_spec", "test/app/ui/sms/device_verification_banner_spec", "test/app/ui/sms/mobile_download_prompt_spec", "test/app/ui/sms/with_sms_country_selector_spec", "test/app/ui/welcome/interests_header_search_spec", "test/app/ui/welcome/import_services_cards_spec", "test/app/ui/welcome/invite_dialog_spec", "test/app/ui/welcome/users_cards_spec", "test/app/ui/welcome/with_nav_buttons_spec", "test/app/ui/welcome/interests_category_flow_nav_spec", "test/app/ui/welcome/with_interests_spec", "test/app/ui/welcome/learn_dashboard_spec", "test/app/ui/welcome/with_welcome_search_spec", "test/app/ui/welcome/second_session_follow_helper_spec", "test/app/ui/welcome/interests_picker_spec", "test/app/ui/welcome/with_similarities_spec", "test/app/ui/welcome/profile_form_spec", "test/app/ui/welcome/internal_link_disabler_spec", "test/app/ui/welcome/profile_flow_nav_spec", "test/app/ui/welcome/customize_profile_spec", "test/app/ui/welcome/lifeline_device_follow_dialog_spec", "test/app/ui/welcome/intro_video_spec", "test/app/ui/welcome/with_more_results_spec", "test/app/ui/media/media_thumbnails_spec", "test/app/ui/media/with_flag_action_spec", "test/app/ui/media/card_thumbnails_spec", "test/app/ui/media/sensitive_media_tweets_spec", "test/app/ui/media/media_preview_spec", "test/app/ui/profile/inline_edit_user_color_spec", "test/app/ui/profile/empty_timeline_owner_spec", "test/app/ui/profile/profile_card_spec", "test/app/ui/profile/alcohol_brand_follower_notification_spec", "test/app/ui/profile/social_proof_spec", "test/app/ui/profile/list_create_button_spec", "test/app/ui/profile/responsive_nav_spec", "test/app/ui/profile/override_user_css_spec", "test/app/ui/profile/sidebar_arrangement_spec", "test/app/ui/profile/scroll_bumps_spec", "test/app/ui/profile/follower_requests_reminder_spec", "test/app/ui/profile/highline_profile_stats_spec", "test/app/ui/profile/sidebar_tweetbox_spec", "test/app/ui/profile/highline_canopy_spec", "test/app/ui/profile/profile_header_image_cropper_sync_spec", "test/app/ui/profile/head_spec", "test/app/ui/profile/canopy_spec", "test/app/ui/gallery/with_gallery_spec", "test/app/ui/gallery/gallery_spec", "test/app/ui/gallery/with_grid_spec", "test/app/ui/who_to_follow/who_to_follow_timeline_spec", "test/app/ui/who_to_follow/with_unmatched_contacts_spec", "test/app/ui/who_to_follow/web_personalized_settings_spec", "test/app/ui/who_to_follow/with_invite_preview_spec", "test/app/ui/who_to_follow/with_invite_messages_spec", "test/app/ui/who_to_follow/with_user_recommendations_spec", "test/app/ui/who_to_follow/who_to_follow_dashboard_spec", "test/app/ui/who_to_follow/with_import_prompt_spec", "test/app/ui/who_to_follow/web_personalized_signup_spec", "test/app/ui/who_to_follow/find_friends_spec", "test/app/ui/who_to_follow/matched_contacts_list_spec", "test/app/ui/who_to_follow/import_services_spec", "test/app/ui/who_to_follow/invite_form_spec", "test/app/ui/promptbird/with_invite_contacts", "test/app/ui/promptbird/with_invite_contacts_spec", "test/app/ui/promptbird/tweet_prompt_spec", "test/app/ui/dialogs/list_membership_dialog_spec", "test/app/ui/dialogs/share_via_email_dialog_spec", "test/app/ui/dialogs/sensitive_flag_confirmation_spec", "test/app/ui/dialogs/signin_or_signup_spec", "test/app/ui/dialogs/list_operations_dialog_spec", "test/app/ui/dialogs/leadgen_confirm_dialog_spec", "test/app/ui/dialogs/in_product_help_dialog_spec", "test/app/ui/dialogs/profile_image_upload_dialog_spec", "test/app/ui/dialogs/embed_tweet_spec", "test/app/ui/dialogs/report_tweet_spec", "test/app/ui/dialogs/profile_confirm_image_delete_dialog_spec", "test/app/ui/dialogs/confirm_email_dialog_spec", "test/app/ui/dialogs/with_modal_tweet_spec", "test/app/ui/dialogs/activity_popup_spec", "test/app/ui/dialogs/promptbird_invite_contacts_dialog_spec", "test/app/ui/dialogs/delete_tweet_dialog_spec", "test/app/ui/dialogs/captcha_challenge_dialog_spec", "test/app/ui/dialogs/iph_search_result_dialog_spec", "test/app/ui/dialogs/create_custom_timeline_dialog_spec", "test/app/ui/dialogs/profile_edit_error_dialog_spec", "test/app/ui/dialogs/block_user_dialog_spec", "test/app/ui/dialogs/keyboard_shortcuts_dialog_spec", "test/app/ui/dialogs/profile_scroll_bump_spec", "test/app/ui/dialogs/age_gate_dialog_spec", "test/app/ui/dialogs/temporary_password_dialog_spec", "test/app/ui/dialogs/confirm_dialog_spec", "test/app/ui/dialogs/tweet_export_dialog_spec", "test/app/ui/dialogs/retweet_dialog_spec", "test/app/ui/dialogs/goto_user_dialog_spec", "test/app/ui/settings/with_cropper_spec", "test/app/ui/settings/sms_phone_verify_form_spec", "test/app/ui/settings/change_photo_spec", "test/app/ui/settings/notifications_spec", "test/app/ui/settings/widgets_configurator_spec", "test/app/ui/settings/tweet_export_download_spec", "test/app/ui/settings/widgets_spec", "test/app/ui/settings/notifications_global_spec", "test/app/ui/settings/facebook_iframe_height_adjuster_spec", "test/app/ui/settings/tweet_export_spec", "test/app/ui/settings/facebook_missing_permissions_spec", "test/app/ui/settings/facebook_spinner_spec", "test/app/ui/settings/facebook_connect_spec", "test/app/ui/settings/facebook_connection_conflict_spec", "test/app/ui/settings/login_verification_sms_check_spec", "test/app/ui/settings/web_notifications_request_spec", "test/app/ui/settings/user_color_picker_spec", "test/app/ui/settings/device_verified_form_spec", "test/app/ui/settings/facebook_login_spec", "test/app/ui/settings/facebook_mismatched_connection_spec", "test/app/ui/settings/sms_phone_create_form_spec", "test/app/ui/settings/facebook_connected_spec", "test/app/ui/account/resend_password_help_controls_spec", "test/app/ui/account/resend_password_controls_spec", "test/app/ui/feedback/feedback_dialog_spec", "test/app/ui/feedback/feedback_report_link_handler_spec", "test/app/ui/signup_download/us_phone_number_checker_spec", "test/app/ui/signup_download/next_and_skip_buttons_spec", "test/app/ui/timelines/with_most_recent_story_pagination_spec", "test/app/ui/timelines/with_pinned_stream_items_spec", "test/app/ui/timelines/discover_timeline_spec", "test/app/ui/timelines/with_min_max_pagination_spec", "test/app/ui/timelines/universal_timeline_spec", "test/app/ui/timelines/with_tweet_pagination_spec", "test/app/ui/timelines/with_keyboard_navigation_spec", "test/app/ui/timelines/custom_timeline_spec", "test/app/ui/timelines/tweet_timeline_spec", "test/app/ui/timelines/with_cursor_pagination_spec", "test/app/ui/timelines/with_story_pagination_spec", "test/app/ui/timelines/with_polling_spec", "test/app/ui/timelines/follower_request_timeline_spec", "test/app/ui/timelines/with_excluded_ids_pagination_spec", "test/app/ui/timelines/user_timeline_spec", "test/app/ui/timelines/with_activity_supplements_spec", "test/app/ui/timelines/with_contextual_tweet_spec", "test/app/ui/timelines/event_timeline_spec", "test/app/ui/forms/with_submit_disable_spec", "test/app/ui/forms/select_box_spec", "test/app/ui/forms/form_value_modification_spec", "test/app/ui/forms/screen_reader_label_spec", "test/app/ui/forms/element_group_toggler_spec", "test/app/data/trends/location_dialog_spec", "test/app/data/trends/recent_locations_spec", "test/app/data/typeahead/trend_locations_datasource_spec", "test/app/data/typeahead/topics_datasource_spec", "test/app/data/typeahead/with_cache_spec", "test/app/data/typeahead/saved_searches_datasource_spec", "test/app/data/typeahead/concierge_datasource_spec", "test/app/data/typeahead/recent_searches_datasource_spec", "test/app/data/typeahead/accounts_datasource_spec", "test/app/data/typeahead/with_external_event_listeners_spec", "test/app/data/typeahead/typeahead_spec", "test/app/data/typeahead/context_helper_datasource_spec", "test/app/data/sms/sms_download_scribe_spec", "test/app/data/sms/device_verification_spec", "test/app/data/welcome/second_session_follow_spec", "test/app/data/welcome/users_cards_spec", "test/app/data/welcome/interests_picker_scribe_spec", "test/app/data/welcome/welcome_alerts_spec", "test/app/data/welcome/welcome_alerts_phone_scribe_spec", "test/app/data/welcome/intro_scribe_spec", "test/app/data/welcome/welcome_data_spec", "test/app/data/welcome/preview_stream_scribe_spec", "test/app/data/welcome/flow_nav_scribe_spec", "test/app/data/welcome/welcome_cards_scribe_spec", "test/app/data/welcome/welcome_alerts_download_scribe_spec", "test/app/data/welcome/invitations_scribe_spec", "test/app/data/welcome/lifeline_scribe_spec", "test/app/data/profile/scroll_bump_scribe_spec", "test/app/data/who_to_follow/web_personalized_scribe_spec", "test/app/data/who_to_follow/web_personalized_proxy_spec", "test/app/data/settings/facebook_proxy_spec", "test/app/data/settings/login_verification_test_run_spec", "test/app/data/settings/web_notifications_submit_spec", "test/app/data/feedback/feedback_spec", "test/app/utils/storage/core_spec", "test/app/utils/storage/with_expiry_spec", "test/app/utils/storage/custom_spec", "test/app/utils/storage/with_crypto_spec", "test/app/utils/image/image_loader_spec", "test/app/utils/crypto/aes_spec", "test/app/ui/trends/dialog/current_location_spec", "test/app/ui/trends/dialog/dialog_spec", "test/app/ui/trends/dialog/with_location_info_spec", "test/app/ui/trends/dialog/recent_trends_spec", "test/app/ui/trends/dialog/with_location_list_picker_spec", "test/app/ui/trends/dialog/location_search_spec", "test/app/ui/trends/dialog/nearby_trends_spec", "test/app/ui/trends/dialog/location_dropdown_spec", "test/app/ui/welcome/alerts/phone_create_form_spec", "test/app/ui/timelines/conversations/descendant_timeline_spec", "test/app/ui/timelines/conversations/ancestor_timeline_spec", "test/app/utils/storage/array/with_max_elements_spec", "test/app/utils/storage/array/with_array_spec", "test/app/utils/storage/array/with_unique_elements_spec", "app/data/welcome/preview_stream_scribe", "app/ui/welcome/with_nav_buttons", "app/ui/welcome/interests_category_flow_nav", "app/ui/welcome/with_similarities", "app/ui/capped_file_upload"],
    "$bundle/boot.d256fe575c28cea8c89ffb7355a9e23159a0ba20.js": ["app/data/geo", "app/data/tweet", "app/ui/dialogs/with_modal_tweet", "app/ui/tweet_dialog", "app/ui/new_tweet_button", "app/data/tweet_box_scribe", "lib/twitter-text", "app/ui/with_character_counter", "app/utils/with_event_params", "app/utils/caret", "app/ui/with_draft_tweets", "app/ui/with_text_polling", "app/ui/with_rtl_tweet_box", "app/ui/toolbar", "app/utils/tweet_helper", "app/utils/html_text", "app/ui/with_rich_editor", "app/ui/with_upload_photo_affordance", "$lib/jquery.swfobject.js", "app/utils/image", "app/utils/drag_drop_helper", "app/ui/with_drop_events", "app/ui/with_droppable_image", "app/ui/tweet_box", "app/utils/image_thumbnail", "app/ui/tweet_box_thumbnails", "app/utils/image_resize", "app/ui/with_image_selection", "app/ui/image_selector", "app/ui/typeahead/accounts_renderer", "app/ui/typeahead/saved_searches_renderer", "app/ui/typeahead/recent_searches_renderer", "app/ui/typeahead/topics_renderer", "app/ui/typeahead/trend_locations_renderer", "app/ui/typeahead/context_helpers_renderer", "app/ui/typeahead/concierge_renderer", "app/utils/rtl_text", "app/ui/typeahead/typeahead_dropdown", "app/utils/event_support", "app/utils/typeahead_helpers", "app/utils/string", "app/ui/typeahead/typeahead_input", "app/ui/with_click_outside", "app/ui/geo_picker", "app/ui/tweet_box_manager", "app/boot/tweet_boxes", "app/ui/user_dropdown", "app/ui/signin_dropdown", "app/ui/search_input", "app/utils/animate_window_scrolltop", "app/ui/global_nav", "app/ui/dm_envelope", "app/ui/navigation_links", "app/data/search_input_scribe", "app/boot/top_bar", "template", "app/ui/dialogs/keyboard_shortcuts_dialog", "app/ui/dialogs/retweet_dialog", "app/ui/dialogs/delete_tweet_dialog", "app/ui/dialogs/block_user_dialog", "app/ui/dialogs/confirm_dialog", "app/ui/dialogs/confirm_email_dialog", "app/ui/dialogs/list_membership_dialog", "app/ui/dialogs/list_operations_dialog", "app/ui/dialogs/create_custom_timeline_dialog", "app/ui/dialogs/captcha_challenge_dialog", "app/data/spam_challenge", "app/data/direct_messages", "app/data/direct_messages_scribe", "app/ui/direct_message_link_handler", "app/ui/with_timestamp_updating", "app/ui/with_item_actions", "app/ui/with_tweetbox_initialization", "app/ui/direct_message_dialog", "app/utils/image/image_resizer", "app/ui/direct_message_media_preview", "app/ui/direct_message_actions", "app/boot/direct_messages", "app/data/profile_popup", "app/data/profile_popup_scribe", "app/ui/user_actions_dropdown", "app/ui/with_user_actions", "app/ui/with_profile_stats", "app/ui/with_handle_overflow", "app/ui/profile_popup", "app/data/profile_edit_btn_scribe", "app/ui/with_position", "app/ui/with_hover_card", "app/ui/profile_hovercard", "app/data/with_email_follow_data", "app/data/user", "app/data/lists", "app/boot/profile_popup", "app/data/typeahead/with_cache", "app/data/with_datasource_helpers", "app/data/typeahead/accounts_datasource", "app/data/typeahead/saved_searches_datasource", "app/data/typeahead/recent_searches_datasource", "app/data/typeahead/with_external_event_listeners", "app/data/typeahead/topics_datasource", "app/data/typeahead/context_helper_datasource", "app/data/typeahead/trend_locations_datasource", "app/data/typeahead/concierge_datasource", "app/data/typeahead/typeahead", "app/data/typeahead_scribe", "app/data/saved_searches", "app/data/saved_searches_scribe", "app/ui/dialogs/goto_user_dialog", "app/utils/setup_polling_with_backoff", "app/ui/page_title", "app/ui/feedback/with_feedback_tweet", "app/ui/feedback/feedback_stories", "app/ui/feedback/with_feedback_discover", "app/ui/feedback/feedback_dialog", "app/ui/feedback/feedback_report_link_handler", "app/data/feedback/feedback", "app/ui/search_query_source", "app/ui/banners/email_banner", "app/data/email_banner", "app/utils/image/image_loader", "app/ui/media/with_flag_action", "app/ui/with_tweet_action_counts", "app/ui/more_tweet_actions_dropdown", "app/ui/with_tweet_actions", "app/ui/gallery/gallery", "app/data/gallery_scribe", "app/data/share_via_email_dialog_data", "app/ui/dialogs/share_via_email_dialog", "app/data/with_widgets", "app/ui/dialogs/embed_tweet", "app/ui/dialogs/report_tweet", "app/data/embed_scribe", "app/data/oembed", "app/data/oembed_scribe", "app/ui/with_drag_events", "app/ui/drag_state", "app/data/notification_listener", "app/data/dm_poll", "app/ui/dashboard", "app/ui/spoonbill", "app/ui/spoonbill_producer", "app/ui/dialogs/uz_survey", "app/ui/sms/with_sms_country_selector", "app/ui/with_loading_indicator", "app/ui/sms/device_verification_banner", "app/data/sms/device_verification", "app/data/sms/sms_download_scribe", "app/ui/global_loading_indicator", "app/ui/dialogs/age_gate_dialog", "app/ui/dialogs/leadgen_confirm_dialog", "app/ui/connect_badge", "app/boot/app"],
    "$bundle/highline.f98b9b87fee72e7ccdd3eaa1136656570f7c5c14.js": ["$lib/jquery_color_picker.js", "app/ui/color_picker", "app/ui/profile/inline_edit_user_color", "app/utils/blend_hex_color", "app/ui/profile/override_user_css", "app/ui/profile/profile_header_image_cropper_sync", "app/ui/profile/add_header_callout", "app/boot/highline_inline_edit", "app/ui/profile/follower_requests_reminder", "app/ui/profile/highline_canopy", "app/ui/dialogs/profile_opt_in_dialog", "app/data/profile_opt_in", "app/data/profile_opt_in_scribe", "app/ui/profile/highline_profile_stats", "app/ui/profile/responsive_nav", "app/ui/profile/sidebar_arrangement", "app/ui/profile/sidebar_tweetbox", "bower_components/flight-viewport/lib/viewport", "app/utils/multiline_text_range", "app/ui/multiline_ellipses", "app/boot/highline_profile", "app/utils/event_proxy", "app/data/with_grid_timeline_data", "app/ui/tweet_actions", "app/ui/timelines/with_contextual_tweet", "app/boot/tweet_grid_timeline", "app/ui/profile/empty_timeline_owner", "app/ui/profile/empty_timeline_tweetbox", "app/ui/prefilled_tweet", "app/data/prefilled_tweet_scribe", "app/ui/profile/profile_card", "app/data/profile_card_scribe", "app/ui/profile/scroll_bumps", "app/data/profile/scroll_bump_scribe", "app/ui/dialogs/profile_scroll_bump", "app/data/users", "app/pages/profile/highline_landing", "app/pages/profile/highline_tweets", "app/pages/profile/highline_favorites", "app/boot/user_grid_timeline", "app/pages/profile/highline_follower_requests", "app/pages/profile/highline_followers", "app/pages/profile/highline_following", "app/pages/profile/highline_media", "app/pages/profile/highline_lists", "app/pages/profile/highline_custom_timelines"],
    "$bundle/frontpage.e3dd0f2d6a4bb43560c997ee17a504ecd34c3ea3.js": ["app/data/frontpage_scribe", "app/ui/cookie_warning", "app/pages/frontpage", "app/data/login_scribe", "app/pages/login"],
    "$bundle/signup.58a85cff4c6ca424542bd61368a4c146598265d7.js": ["app/ui/signup/with_captcha", "app/utils/common_regexp", "app/ui/signup/with_signup_validation", "app/ui/signup/signup_form", "app/ui/with_password_strength", "app/data/signup_data", "app/data/settings", "app/data/signup_scribe", "app/ui/signup/suggestions", "app/ui/signup/small_print_expander", "app/ui/signup_download/us_phone_number_checker", "app/pages/signup/signup", "app/ui/signup/country_code_select", "app/ui/signup/country_code_display", "app/ui/signup/signup_digits_scribe", "app/pages/signup/signup_digits"],
    "$bundle/timeline.a75a2acbaf562d8f43a2ea935b0a89e7bc480184.js": ["app/data/tweet_actions", "app/utils/scale_animation_time", "app/ui/expando/with_expanding_containers", "app/ui/expando/expando_helpers", "app/ui/gallery/with_gallery", "app/ui/with_tweet_translation", "app/ui/with_viewer_follow_state", "app/ui/tweets", "app/ui/tweet_injector", "app/ui/expando/with_expanding_social_activity", "app/ui/expando/with_expanding_conversations", "bower_components/xdm.js/xdm", "app/ui/with_card", "app/ui/with_tweet_click_handler", "app/ui/with_tweet_activity_actions", "app/ui/expando/expanding_tweets", "app/ui/embed_stats", "app/ui/media/with_native_media", "app/ui/media/media_tweets", "app/data/trends", "app/data/trends/location_dialog", "app/data/trends/recent_locations", "app/utils/scribe_event_initiators", "app/data/trends_scribe", "app/ui/trends/with_share_trends", "app/ui/trends/trends", "app/ui/trends/trends_dialog", "app/ui/trends/dialog/with_location_info", "app/ui/trends/dialog/location_dropdown", "app/ui/trends/dialog/location_search", "app/ui/trends/dialog/current_location", "app/ui/trends/dialog/with_location_list_picker", "app/ui/trends/dialog/nearby_trends", "app/ui/trends/dialog/recent_trends", "app/ui/trends/dialog/dialog", "app/boot/trends", "app/ui/infinite_scroll_watcher", "app/data/timeline", "app/boot/timeline", "app/data/activity_popup", "app/ui/dialogs/activity_popup", "app/data/activity_popup_scribe", "app/boot/activity_popup", "app/data/tweet_activity_counts_scribe", "app/data/curation", "app/data/tweet_translation", "app/data/conversations", "app/data/media_settings", "app/ui/dialogs/sensitive_flag_confirmation", "app/ui/media/sensitive_media_tweets", "app/ui/user_actions", "app/boot/tweets", "app/boot/help_pips_enable", "app/data/help_pips", "app/data/help_pips_scribe", "app/ui/help_pip", "app/ui/help_pips_injector", "app/boot/help_pips", "app/ui/expando/close_all_button", "app/ui/timelines/with_keyboard_navigation", "app/ui/with_focus_highlight", "app/ui/timelines/with_base_timeline", "app/ui/timelines/with_old_items", "app/utils/chrome", "app/ui/timelines/with_traveling_ptw", "app/ui/timelines/with_autoplaying_timeline", "app/ui/timelines/with_polling", "app/ui/timelines/with_new_items", "app/ui/timelines/with_tweet_pagination", "app/ui/timelines/with_activity_supplements", "app/ui/with_conversation_actions", "app/ui/timelines/with_pinned_stream_items", "app/ui/timelines/tweet_timeline", "app/boot/tweet_timeline", "app/ui/user_completion_module", "app/data/user_completion_module_scribe", "app/boot/user_completion_module", "app/ui/who_to_follow/with_import_prompt", "app/ui/who_to_follow/with_user_recommendations", "app/ui/who_to_follow/who_to_follow_dashboard", "app/data/who_to_follow/wtf_import_prompt_scribe", "app/utils/oauth_popup", "app/ui/with_import_services", "app/ui/who_to_follow/who_to_follow_timeline", "app/data/who_to_follow", "app/data/who_to_follow_scribe", "app/ui/profile/recent_connections_module", "app/ui/promptbird/with_invite_contacts", "app/ui/promptbird", "app/data/promptbird", "app/data/promptbird_scribe", "app/ui/with_select_all", "app/ui/who_to_follow/with_invite_messages", "app/ui/who_to_follow/with_invite_preview", "app/ui/who_to_follow/with_unmatched_contacts", "app/ui/dialogs/promptbird_invite_contacts_dialog", "app/ui/promptbird/tweet_prompt", "app/data/contact_import", "app/data/contact_import_scribe", "app/ui/who_to_follow/import_services", "app/ui/who_to_follow/import_loading_dialog", "app/ui/dashboard_tweetbox", "app/utils/boomerang", "app/ui/profile_stats", "app/utils/prefetch_core_css_bundle", "app/ui/sms/mobile_download_prompt", "app/pages/home", "app/boot/wtf_module", "app/data/who_to_tweet", "app/boot/connect", "app/ui/who_to_follow/with_list_resizing", "app/ui/who_to_follow/matched_contacts_list", "app/ui/who_to_follow/unmatched_contacts_list", "app/ui/who_to_tweet", "app/ui/who_to_follow/find_friends", "app/data/interaction_timeline_actions", "app/pages/connect/interactions", "app/pages/connect/mentions", "app/pages/connect/network_activity", "app/ui/inline_edit", "app/data/async_profile", "$lib/jquery_ui.profile.js", "$lib/jquery_webcam.js", "app/ui/settings/with_cropper", "app/ui/settings/with_webcam", "app/ui/with_verify_upload_type", "app/utils/is_showing_avatar_options", "app/ui/dialogs/profile_image_upload_dialog", "app/ui/dialogs/profile_edit_error_dialog", "app/ui/dialogs/profile_confirm_image_delete_dialog", "app/ui/droppable_image", "app/data/inline_edit_scribe", "app/data/settings/profile_image_upload_scribe", "app/data/drag_and_drop_scribe", "app/ui/settings/change_photo", "app/ui/image_uploader", "app/ui/inline_profile_editing_initializor", "app/utils/hide_or_show_divider", "app/ui/with_inline_image_options", "app/ui/with_inline_image_editing", "app/ui/inline_profile_editing", "app/data/settings", "app/ui/profile_edit_param", "app/ui/edit_header_button", "app/ui/alert_banner_to_message_drawer", "app/boot/inline_edit", "app/ui/profile/canopy", "app/data/profile_canopy_scribe", "app/ui/profile/head", "app/data/profile_head_scribe", "app/ui/profile/social_proof", "app/data/profile_social_proof_scribe", "app/ui/media/card_thumbnails", "app/data/media_timeline", "app/data/media_thumbnails_scribe", "app/ui/suggested_users", "app/data/suggested_users", "app/ui/profile/alcohol_brand_follower_notification", "app/boot/profile", "app/pages/profile/tweets", "app/ui/timelines/with_cursor_pagination", "app/ui/with_stream_users", "app/ui/timelines/with_excluded_ids_pagination", "app/ui/timelines/user_timeline", "app/data/honeypot_scribe", "app/boot/user_timeline", "app/ui/timelines/follower_request_timeline", "app/data/follower_request", "app/data/follower_request_scribe", "app/pages/profile/follower_requests", "app/pages/profile/followers", "app/pages/profile/following", "app/pages/profile/favorites", "app/ui/timelines/list_timeline", "app/boot/list_timeline", "app/ui/profile/list_create_button", "app/pages/profile/lists", "app/ui/with_removable_stream_items", "app/ui/similar_to", "app/pages/profile/similar_to", "app/ui/gallery/with_grid", "app/ui/timelines/grid_timeline", "app/boot/grid_timeline", "app/pages/profile/media", "app/ui/timelines/custom_timelines_timeline", "app/boot/custom_timelines_timeline", "app/ui/profile/custom_timeline_create_button", "app/pages/profile/custom_timelines", "app/ui/timelines/with_min_max_pagination", "app/ui/timelines/custom_timeline", "app/ui/custom_timeline_tweetbox", "app/ui/custom_timeline_follow_card", "app/boot/custom_timeline", "app/pages/custom_timeline", "app/ui/dialogs/iph_search_result_dialog", "app/ui/search/archive_navigator", "app/data/archive_navigator_scribe", "app/ui/search_actions", "app/boot/search", "app/ui/timelines/with_story_pagination", "app/ui/timelines/universal_timeline", "app/boot/universal_timeline", "app/ui/search/spelling_corrections", "app/ui/search/related_queries", "app/data/search_assistance_scribe", "app/data/timeline_controls_scribe", "app/ui/dynamic_card_watcher", "app/pages/search/search", "app/ui/timelines/media_timeline", "app/boot/media_timeline", "app/pages/search/media", "app/ui/media/media_preview", "app/boot/preexpanded_cards", "app/ui/dropdown_toggle", "app/pages/explore/explore", "app/pages/explore/landing", "app/pages/simple_t1", "lib/hogan/template"],
    "$bundle/permalink.a5f1b86a6448baee6e2320af42d79c1abbaa8332.js": ["app/ui/permalink_keyboard_support", "app/ui/hidden_ancestors", "app/ui/hidden_descendants", "app/ui/dialogs/sms_codes", "app/ui/timelines/conversations/descendant_timeline", "app/ui/timelines/conversations/ancestor_timeline", "app/ui/related_tweets", "app/data/related_tweets", "app/data/embed_stats_scribe", "app/data/permalink_scribe", "app/pages/permalink", "app/pages/permalink_photo"],
    "$bundle/lists_permalink.e0340b39bfd6d61402539e538aae13de11d7de32.js": ["app/ui/list_members_dashboard", "app/data/list_members_dashboard", "app/ui/list_follow_card", "app/data/list_follow_card", "app/boot/list_permalink", "app/pages/list/permalink_tweets", "app/pages/list/permalink_users"],
    "$bundle/discover.fb4ea6046290360919eac9df3969d6c9c7a65c7b.js": ["app/ui/discover_nav", "app/boot/discover", "app/ui/timelines/with_most_recent_story_pagination", "app/ui/timelines/discover_timeline", "app/boot/discover_timeline", "app/data/topic_pivots_scribe", "app/ui/with_topic_pivots", "app/ui/discover", "app/pages/discover/discover", "app/ui/people_search_input", "app/boot/who_to_follow", "app/utils/common_regexp", "app/ui/who_to_follow/invite_form", "app/ui/who_to_follow/pymk_kicker", "app/ui/who_to_follow/wipe_addressbook_dialog", "app/pages/who_to_follow/import", "app/pages/who_to_follow/interests", "app/pages/who_to_follow/invite", "app/pages/who_to_follow/lifeline", "app/pages/who_to_follow/matches", "app/pages/who_to_follow/suggestions", "app/data/who_to_follow/web_personalized_scribe", "app/data/who_to_follow/web_personalized_proxy", "app/ui/who_to_follow/web_personalized_settings", "app/ui/who_to_follow/web_personalized_signup", "app/pages/who_to_follow/web_personalized"],
    "$bundle/settings.978f38c4e963861843ee2f103a70b685c8a06086.js": ["app/ui/alert_banner", "app/ui/forms/with_submit_disable", "app/ui/forms/form_value_modification", "app/data/email_follow_data", "app/boot/settings", "app/data/settings/account_scribe", "app/data/form_scribe", "app/ui/with_forgot_password", "app/ui/password_dialog", "app/ui/email_field_highlight", "app/ui/validating_fieldset", "app/ui/email_confirmation", "app/ui/settings/tweet_export", "app/ui/dialogs/tweet_export_dialog", "app/ui/timezone_detector", "app/ui/deactivated", "app/ui/settings_controls", "app/pages/settings/account", "app/data/settings/login_verification_test_run", "app/ui/settings/login_verification_sms_check", "app/ui/login_verification_confirmation_dialog", "app/ui/protected_verified_dialog", "app/ui/geo_deletion", "app/pages/settings/security", "app/data/settings/applications_scribe", "app/ui/oauth_revoker", "app/pages/settings/applications", "app/data/settings/confirm_deactivation_scribe", "app/pages/settings/confirm_deactivation", "app/data/settings/design_scribe", "$lib/jquery_color_picker.js", "app/ui/color_picker", "app/ui/design", "app/ui/theme_preview", "app/utils/blend_hex_color", "app/ui/profile/override_user_css", "app/ui/theme_picker", "app/pages/settings/design", "app/pages/settings/email_follow", "app/ui/settings/tweet_export_download", "app/pages/settings/tweet_export_download", "app/ui/settings/notifications", "app/ui/settings/notifications_global", "app/pages/settings/notifications", "app/ui/password", "app/ui/password_match_pair", "app/ui/with_password_strength", "app/ui/password_strength", "app/data/temporary_password", "app/ui/dialogs/temporary_password_dialog", "app/ui/temporary_password_button", "app/pages/settings/password", "app/ui/profile_image_monitor", "app/boot/avatar_uploading", "app/data/settings/profile_scribe", "app/ui/settings/facebook_iframe_height_adjuster", "app/ui/field_edit_warning", "app/ui/dialogs/in_product_help_dialog", "app/boot/header_upload", "app/ui/bio_box", "app/ui/settings/user_color_picker", "app/pages/settings/profile", "app/data/settings/facebook_proxy", "app/ui/settings/with_facebook_container", "app/ui/settings/facebook_spinner", "app/ui/settings/with_facebook_banner", "app/ui/settings/facebook_login", "app/ui/settings/facebook_connect", "app/ui/settings/facebook_missing_permissions", "app/ui/settings/facebook_mismatched_connection", "app/ui/settings/facebook_connection_conflict", "app/ui/settings/facebook_connected", "app/data/settings/facebook_scribe", "app/pages/settings/facebook", "app/data/settings/sms_scribe", "app/ui/forms/select_box", "app/ui/settings/sms_phone_create_form", "app/ui/forms/element_group_toggler", "app/ui/settings/device_verified_form", "app/ui/settings/sms_phone_verify_form", "app/pages/settings/sms", "app/ui/settings/web_notifications_request", "app/data/settings/web_notifications_submit", "app/pages/settings/web_notifications", "app/ui/settings/widgets", "app/pages/settings/widgets", "app/ui/settings/widgets_configurator", "app/pages/settings/widgets_configurator"],
    ...
    "$bundle/events.8bf1e32876e10fa039ac8035c5c7009335b514f1.js": ["app/ui/media/media_thumbnails", "app/ui/timelines/event_timeline", "app/ui/page_visibility", "app/data/page_visibility_scribe", "app/pages/events/hashtag"],
    ...
    "$bundle/search.23b0a1824bdd02e1f774d12b3da7acb03d34377a.js": ["app/ui/dialogs/search_operators_dialog", "app/pages/search/home", "app/ui/advanced_search", "app/pages/search/advanced"],
...
define("bower_components/flight/lib/utils", [], function() {
    "use strict";
    var a = [],
        b = 100,
        c = {
            ...
            merge: function() {
                var a = arguments.length,
                    b = 0,
                    c = new Array(a + 1);
                for (; b < a; b++) c[b + 1] = arguments[b];
                return a === 0 ? {} : (c[0] = {}, c[c.length - 1] === !0 && (c.pop(), c.unshift(!0)), $.extend.apply(undefined, c))
            },
            push: function(a, b, c) {
                return a && Object.keys(b || {}).forEach(function(d) {
                    if (a[d] && c) throw new Error('utils.push attempted to overwrite "' + d + '" while running in protected mode');
            ...
            delegate: function(a) {
                return function(b, c) {
                    ...
                    Object.keys(a).forEach(function(f) {
                        if (!b.isPropagationStopped() && (e = d.closest(f)).length) return c = c || {}, c.el = e[0], a[f].apply(this, [b, c])
                    }, this)
                }
            },
            once: function(a) {
                var b, c;
                return function() {
                    return b ? c : (c = a.apply(this, arguments), b = !0, c)
                }
            }
        };
    return c
...
define("bower_components/flight/lib/debug", [], function() {
    function a(b, d, e) {
        e = e || {};
        var f = e.obj || window,
            g = e.path || (f == window ? "window" : ""),
            h = Object.keys(f);
        h.forEach(function(e) {
            (c[b] || b)(d, f, e) && console.log([g, ".", e].join(""), "->", ["(", typeof f[e], ")"].join(""), f[e]), Object.prototype.toString.call(f[e]) == "[object Object]" && f[e] != f && g.split(".").indexOf(e) == -1 && a(b, d, {
                obj: f[e],
                path: [g, e].join(".")
            })
        })
    ...
    function n() {
        ...
        m.eventNames.length || (m.eventNames = j), m.actions = a.length ? a : j, r()
    }

    function o() {
        var a = [].slice.call(arguments);
        m.actions.length || (m.actions = j), m.eventNames = a.length ? a : j, r()
    }

    function p() {
        m.actions = [], m.eventNames = [], r()
    }

    function q() {
        m.actions = j, m.eventNames = j, r()
    }
    ...
    function s() {
        var a = {
            eventNames: window.localStorage && localStorage.getItem("logFilter_eventNames") || k,
            actions: window.localStorage && localStorage.getItem("logFilter_actions") || l
        };
        return Object.keys(a).forEach(function(b) {
            var c = a[b];
            typeof c == "string" && c !== j && (a[b] = c.split(","))
        }), a
    }
    "use strict";
    var c = {
...
define("bower_components/flight/lib/compose", ["./utils", "./debug"], function(a, b) {
    function f(a, b) {
        if (!c) return;
...
define("bower_components/flight/lib/advice", ["./compose"], function(a) {
    "use strict";
    var b = {
        around: function(a, b) {
            return function() {
        ...
        withAdvice: function() {
            ["before", "after", "around"].forEach(function(c) {
                this[c] = function(d, e) {
                    a.unlockProperty(this, d, function() {
    ...
    function c() {
        ...
        function e(a) {
            this.instance = a, this.events = [], this.addBind = function(a) {
                ...
                for (var c = 0, d; d = this.events[c]; c++) b(d, a) && this.events.splice(c, 1)
            }
        }
        var c = this;
        (this.reset = function() {
            ...
            var d = c.findInstanceInfo(this),
                e, f = arguments.length,
                g = 1,
                h = new Array(f - 1);
            for (; g < f; g++) h[g - 1] = arguments[g];
            if (d) {
            ...
            var d = a(this, arguments),
                e = c.findInstanceInfo(this);
            e && e.removeBind(d);
            for (var f = 0, g; g = c.events[f]; f++) b(g, d) && c.events.splice(f, 1)
...
define("bower_components/flight/lib/base", ["./utils", "./registry", "./debug"], function(a, b, c) {
    ...
    function h() {
        this.trigger = function() {
            var a, b, d, e, g, h = arguments.length - 1,
                i = arguments[h];
            return typeof i != "string" && (!i || !i.defaultBehavior) && (h--, d = i), h == 1 ? (a = $(arguments[0]), e = arguments[1]) : (a = this.$node, e = arguments[0]), e.defaultBehavior && (g = e.defaultBehavior, e = $.Event(e.type)), b = e.type || e, c.enabled && window.postMessage && f.call(this, b, d), typeof this.attr.eventData == "object" && (d = $.extend(!0, {}, this.attr.eventData, d)), a.trigger(e || b, d), g && !e.isDefaultPrevented() && (this[g] || g).call(this), a
        }, this.on = function() {
            var b, c, d, e, f = arguments.length - 1,
                h = arguments[f];
            typeof h == "object" ? e = a.delegate(this.resolveDelegateRules(h)) : typeof h == "string" ? e = g(h) : e = h, f == 2 ? (b = $(arguments[0]), c = arguments[1]) : (b = this.$node, c = arguments[0]);
            ...
            typeof arguments[d] == "function" && (c = arguments[d], d -= 1), d == 1 ? (a = $(arguments[0]), b = arguments[1]) : (a = this.$node, b = arguments[0]);
            if (c) {
                var e = c.target ? c.target.bound : c.bound || [];
                e && e.some(function(a, b, d) {
                    if (a.context && this.identity == a.context.identity) return d.splice(b, 1), c = a, !0
                }, this)
            }
            return a.off(b, c)
            ...
            return Object.keys(a).forEach(function(c) {
                if (!(c in this.attr)) throw new Error('Component "' + this.toString() + '" wants to listen on "' + c + '" but no such attribute was defined.');
                b[this.attr[c]] = typeof a[c] == "string" ? g(a[c]) : a[c]
            }, this), b
            ...
            a.jquery ? (this.node = a[0], this.$node = a) : (this.node = a, this.$node = $(a));
            var c = Object.create(b);
            for (var e in this.defaults) b.hasOwnProperty(e) || (c[e] = this.defaults[e]);
            return this.attr = c, this
...
define("bower_components/flight/lib/logger", ["./utils"], function(a) {
    ...
    function d(a, d, e) {
        ...
        typeof e[e.length - 1] == "function" && (i = e.pop(), i = i.unbound || i), e.length == 1 ? (h = d.$node[0], g = e[0]) : e.length == 2 && typeof e[1] == "object" && !e[1].type ? (h = d.$node[0], g = e[0], a == "trigger" && (j = e[1])) : (h = e[0], g = e[1], a == "trigger" && (j = e[2])), f = typeof g == "object" ? g.type : g, k = DEBUG.events.logFilter, m = k.actions == "all" || k.actions.indexOf(a) > -1, l = function(a) {
            ...
            return l(a).test(f)
        }), m && n && (o = [b[a], a, "[" + f + "]"], j && o.push(j), o.push(c(h)), o.push(d.constructor.describe.split(" ").slice(0, 3).join(" ")), console.info.apply(console, o))
    }
...
define("bower_components/flight/lib/component", ["./advice", "./utils", "./compose", "./base", "./registry", "./logger", "./debug"], function(a, b, c, d, e, f, g) {
    ...
    function k(a) {
        var c = arguments.length,
            d = new Array(c - 1);
        for (var f = 1; f < c; f++) d[f - 1] = arguments[f];
        if (!a) throw new Error("Component needs to be attachTo'd a jQuery object, native node or selector string");
        var g = b.merge.apply(b, d),
            h = e.findComponentInfo(this);
        $(a).each(function(a, b) {
            if (h && h.isAttachedTo(b)) return;
    ...
    function l() {
        var b = arguments.length,
            j = new Array(b + 3);
        for (var l = 0; l < b; l++) j[l] = arguments[l];
        var m = function() {};
        return m.toString = m.prototype.toString = function() {
            ...
            return a
        }, g.enabled && (m.describe = m.prototype.describe = m.toString()), m.attachTo = k, m.teardownAll = i, g.enabled && j.unshift(f), j.unshift(d, a.withAdvice, e.withRegistration), c.mixin(m.prototype, j), m
    }
    "use strict";
    var h = /function (.*?)\s?\(/;
...
define("core/clock", ["module", "require", "exports", "core/component", "core/registry"], function(module, require, exports) {
    ...
    function Clock() {
        this.timers = [], this.clockComponent = function() {
            if (!this.currentClock || !registry.findInstanceInfo(this.currentClock)) this.reset(), this.currentClock = (new ClockComponent(document)).initialize(document);
...
define("core/parameterize", ["module", "require", "exports"], function(module, require, exports) {
    ...
    module.exports = function(a, b, c) {
        return b ? a.replace(tokenizerRE, function(a, d) {
            if (d) {
                if (b[d]) return b[d];
                if (c) throw new Error("Cannot parameterize string, no replacement found for " + d);
                return ""
            }
            return a
        }) : a
...
define("app/utils/auth_token", ["module", "require", "exports"], function(module, require, exports) {
    ...
    module.exports = {
        get: function() {
            if (!authToken) throw new Error("authToken should have been set!");
            return authToken
        },
        set: function(a) {
            authToken = a
    ...
    ScribeTransport.prototype = {
        ...
        storeData: function(a, b) {
            try {
                ...
                if (c.name !== "QuotaExceededError" && c.message !== "QuotaExceededError" && c.name !== "NS_ERROR_DOM_QUOTA_REACHED" && c.name !== "QUOTA_EXCEEDED_ERR" && c.number !== -2147024882) throw c;
        ...
        addToBuffer: function(a) {
            var b = this.getBuffer(),
                c = this.encodeEventData(a),
                d = this.appendData(b, c);
...
define("app/data/with_interaction_data_scribe", ["module", "require", "exports", "core/compose", "app/data/with_scribe", "app/utils/with_session", "app/utils/scribe_item_types", "app/utils/scribe_association_types", "app/data/client_event", "core/utils"], function(module, require, exports) {
    function withInteractionDataScribe() {
        this.defaultAttrs({
            ...
            var h = (d == "report_as_spam" || d == "block") && a.component != "report_tweet";
            if (h) {
            ...
            var b = a.scribeContext.component,
                c;
...
define("app/data/with_conversation_metadata", ["module", "require", "exports"], function(module, require, exports) {
    module.exports = function() {
        this.defaultAttrs({
            ...
            } else c.hasClass("conversation-tweet") && (b.isConversationComponent = !0, b.description = c.hasClass(this.attr.rootClass) ? "root" : "ancestor");
            return b
...
define("app/ui/with_interaction_data", ["module", "require", "exports", "core/compose", "core/utils", "app/data/with_card_metadata", "app/data/with_conversation_metadata"], function(module, require, exports) {
    function withInteractionData() {
        ...
        this.interactionDataWithCard = function(a, b) {
            ...
            var h = utils.merge(this.getEventData(g, f), b),
                i = g.closest(this.attr.scribeContextSelector).data("scribe-context");
            ...
            var b, c = -1,
                d = a.closest(this.attr.expandoAncestorSelector),
...
define("app/data/report_tweet_scribe", ["module", "require", "exports", "core/component", "core/utils", "app/utils/scribe_item_types", "app/utils/scribe_association_types", "app/data/with_interaction_data_scribe"], function(module, require, exports) {
    function reportTweetScribe() {
        this.reportTweetImpression = function(a, b) {
            this.scribeReportTweetEvent({
                component: "report_tweet",
                action: "impression"
            }, b)
        }, this.reportTweetAbuseImpression = function(a, b) {
            this.scribeReportTweetEvent({
                component: "report_tweet_abusive",
                action: "impression"
            }, b)
        }, this.cancelReportTweet = function(a, b) {
            this.scribeReportTweetEvent({
                component: "report_tweet",
                action: "cancel"
            }, b)
        }, this.cancelReportTweetAbusive = function(a, b) {
            this.scribeReportTweetEvent({
                component: "report_tweet_abusive",
                action: "cancel"
            }, b)
        }, this.reportTweetSubmit = function(a, b) {
            var c = b.reportType ? b.reportType : "",
                d = {
                    component: "report_tweet",
                    action: b.blockUser ? "block" : "report_as_spam",
                    element: c
                };
            this.scribeReportTweetEvent(d, b.tweetData)
        }, this.reportTweetAbuseToSupport = function(a, b) {
            var c = {
                component: "report_tweet_abusive",
                element: b.abuseType,
                action: "click"
            };
            this.scribeReportTweetEvent(c, b.tweetData)
            ...
            this.on(document, "uiNeedsReportTweetDialog", this.reportTweetImpression), this.on(document, "uiDidShowReportAbusiveTweetDialog", this.reportTweetAbuseImpression), this.on(document, "uiDidReportTweet", this.reportTweetSubmit), this.on(document, "uiDidReportTweetToSupport", this.reportTweetAbuseToSupport), this.on(document, "uiDidCancelReportTweet", this.cancelReportTweet), this.on(document, "uiDidCancelReportTweetAbusive", this.cancelReportTweetAbusive)
        })
    }
    var defineComponent = require("core/component"),
        utils = require("core/utils"),
        ...
        associationTypes = require("app/utils/scribe_association_types"),
        withInteractionDataScribe = require("app/data/with_interaction_data_scribe");
    module.exports = defineComponent(reportTweetScribe, withInteractionDataScribe)
});
define("app/data/user_actions_scribe", ["module", "require", "exports", "core/component", "app/utils/scribe_item_types", "app/utils/scribe_association_types", "app/data/with_interaction_data_scribe"], function(module, require, exports) {
    function userActionsScribe() {
        ...
        this.defaultAttrs({
            ...
            this.on(document, "dataFollowStateChange dataUserActionSuccess dataEmailFollow dataEmailUnfollow", this.handleUserEvent), this.on(document, "uiMentionAction uiListAction uiDmAction uiRetweetOnAction uiRetweetOffAction uiDeviceNotificationsOnAction uiDeviceNotificationsOffAction uiShowMobileNotificationsConfirm uiShowPushTweetsNotificationsConfirm uiEmailFollowAction uiEmailUnfollowAction uiUserTopicClickAction", this.handleAction)
        })
    }
    var defineComponent = require("core/component"),
        itemTypes = require("app/utils/scribe_item_types"),
...
define("app/data/item_actions_scribe", ["module", "require", "exports", "core/component", "app/data/with_interaction_data_scribe", "app/data/with_conversation_metadata", "app/data/with_card_metadata"], function(module, require, exports) {
    function itemActionsScribe() {
        this.defaultAttrs({
            ...
            c.userId = b.user_id;
            if (c.interactionInsideCard) this.scribeCardAction(d, a, c);
            else {
...
define("app/data/simple_event_scribe", ["module", "require", "exports", "core/component", "app/data/with_scribe"], function(module, require, exports) {
    function simpleEventScribe() {
        this.defaultAttrs({
            ...
            this.on("uiEnableEmailFollowAction", this.scribeSimpleEvent), this.on("uiDisableEmailFollowAction", this.scribeSimpleEvent), this.on("uiEmailFollowFormSubmitAction", this.scribeSimpleEvent)
        })
    }
    var defineComponent = require("core/component"),
        withScribe = require("app/data/with_scribe");
...
define("app/boot/scribing", ["module", "require", "exports", "app/data/scribe_transport", "app/data/scribe_monitor", "app/data/client_event", "app/data/tweet_actions_scribe", "app/data/report_tweet_scribe", "app/data/user_actions_scribe", "app/data/item_actions_scribe", "app/data/navigation_scribe", "app/data/simple_event_scribe", "app/utils/cookie"], function(module, require, exports) {
    function initialize(a) {
        ...
        }), TweetActionsScribe.attachTo(document, a), ReportTweetScribe.attachTo(document, a), UserActionsScribe.attachTo(document, a), ItemActionsScribe.attachTo(document, a), NavigationScribe.attachTo(document, a), SimpleEventScribe.attachTo(document, a)
    }
    var scribeTransport = require("app/data/scribe_transport"),
        ScribeMonitor = require("app/data/scribe_monitor"),
        clientEvent = require("app/data/client_event"),
        TweetActionsScribe = require("app/data/tweet_actions_scribe"),
        ReportTweetScribe = require("app/data/report_tweet_scribe"),
...
define("app/ui/navigation", ["module", "require", "exports", "core/component", "app/utils/full_path"], function(module, require, exports) {
    function navigation() {
        this.defaultAttrs({
            ...
            this.hideSpinner(), this.trigger("uiBeforePageChanged", b), this.trigger("uiTeardown", b), $("body").attr("class", b.init_data.bodyFoucClassNames + " " + b.body_class_names), this.select("docContainer").attr("class", b.doc_class_names), this.select("pageContainer").attr("class", b.page_container_class_names);
            var d = b.banners && !b.fromCache ? b.banners + b.page : b.page;
            this.$node.find(b.init_data.viewContainer).html(d), b.isPopState || $(window).scrollTop(0), using(b.module, function(a) {
            ...
            a.originalEvent.state && (isSafari && (document.body.style.display = "none", document.body.offsetHeight, document.body.style.display = "block"), this.trigger("uiNavigate", {
                isPopState: !0,
                href: fullPath()
            }))
        }, this.after("initialize", function() {
            this.on("click", this.navigate), this.on(window, "popstate", this.onPopState), this.on("dataPageRefresh", this.updatePage), this.on("dataPageFetch", this.showSpinner)
        })
    }
...
define("app/data/notifications", ["module", "require", "exports", "app/utils/storage/core", "app/utils/time"], function(module, require, exports) {
    ...
    var Storage = require("app/utils/storage/core"),
        ...
        filteredEndpoints = ["/i/users/recommendations", "/i/timeline", "/i/connect/timeline", "/i/discover/timeline", "/i/search/timeline", "/i/profiles/show", "/messages"];
...
define("app/utils/querystring", ["module", "require", "exports"], function(module, require, exports) {
    ...
    function queryEncode(a) {
        var b = [];
        for (var c in a) a[c] !== null && typeof a[c] != "undefined" && b.push(encodeQueryPart(c) + "=" + encodeQueryPart(a[c]));
        return b.sort().join("&")
    }
    ...
    function queryDecode(a) {
        ...
        if (a) {
            c = a.split("&");
            for (f = 0; e = c[f]; f++) d = e.split("="), d.length == 2 && (b[decodeQueryPart(d[0])] = decodeQueryPart(d[1]))
        }
        return b
    }
    module.exports = {
            ...
            var a = 14,
                ...
                e = function(a) {
                    ...
                    var b = [],
                        c;
                    if (!d)
                        for (c = 0; c < 4; c++) b[c * 4] = D[a[c * 4]] ^ E[a[1 + c * 4]] ^ a[2 + c * 4] ^ a[3 + c * 4], b[1 + c * 4] = a[c * 4] ^ D[a[1 + c * 4]] ^ E[a[2 + c * 4]] ^ a[3 + c * 4], b[2 + c * 4] = a[c * 4] ^ a[1 + c * 4] ^ D[a[2 + c * 4]] ^ E[a[3 + c * 4]], b[3 + c * 4] = E[a[c * 4]] ^ a[1 + c * 4] ^ a[2 + c * 4] ^ D[a[3 + c * 4]];
                    else
                        for (c = 0; c < 4; c++) b[c * 4] = I[a[c * 4]] ^ G[a[1 + c * 4]] ^ H[a[2 + c * 4]] ^ F[a[3 + c * 4]], b[1 + c * 4] = F[a[c * 4]] ^ I[a[1 + c * 4]] ^ G[a[2 + c * 4]] ^ H[a[3 + c * 4]], b[2 + c * 4] = H[a[c * 4]] ^ F[a[1 + c * 4]] ^ I[a[2 + c * 4]] ^ G[a[3 + c * 4]], b[3 + c * 4] = G[a[c * 4]] ^ H[a[1 + c * 4]] ^ F[a[2 + c * 4]] ^ I[a[3 + c * 4]];
                    return b
                }, v = function(a, b, c) {
                    var d = [],
                        e;
...
define("app/data/with_data", ["module", "require", "exports", "core/compose", "core/i18n", "app/data/notifications", "app/utils/params", "app/data/with_auth_token", "app/utils/storage/custom", "app/utils/storage/core", "app/data/profile_info"], function(module, require, exports) {
    ...
    function withData() {
        ...
        this.composeData = function(a, b) {
            ...
            return initializeXhrStorage(),
            function(d, e, f) {
                a.slice(a.indexOf(f), 1);
                var g = d,
                    h = null,
                    i = encodeURIComponent(c.url);
            ...
            return function(d) {
                ...
                var e;
                try {
                    e = JSON.parse(d.responseText), e && e.challengeType ? this.trigger(document, "dataInitialChallengeNeeded", e) : e && e.message && !this.attr.noShowError && this.trigger("uiShowError", e)
                } catch (f) {
                    e = {
                        xhr: {}
            ...
            f = $.extend(f, this.extractParams(h, window.location)), b.success && (b.success = this.createSuccessHandler(b.success, b)), b.error && (b.error = this.createErrorHandler(b.error, b)), $.extend(f, notifications.extraParameters(b.url)), Profile.info && Profile.info.presentation && $.extend(b.headers, {
                "X-PROF": Profile.info.presentation
            }), this.attr.includePageContext && this.attr.pageContext && (f.page_context = this.attr.pageContext);
            var i = $.ajax($.extend(b, {
                url: b.url,
...
define("app/data/navigation", ["module", "require", "exports", "core/component", "core/utils", "core/registry", "app/utils/time", "app/utils/full_path", "app/data/with_data"], function(module, require, exports) {
    function navigationData() {
        ...
        this.pageCache = {}, this.pageCacheTTLs = {}, this.navigateUsingPushState = function(a, b) {
            ...
            if (!c && b.href == e && this.pageCache[e]) return;
            ...
            a != fullPath() && history.pushState({}, b.title, a), b.isPopState = c, this.trigger("dataPageRefresh", b)
            ...
            a.init_data = utils.merge(this.attr.init_data, !0), delete a.init_data.initialState, this.attr.init_data.initialState = null, this.cacheState(b, a), history.replaceState({}, a.title, b)
            ...
            this.attr.pushState && this.attr.pushStateSupported ? (this.on("uiSwiftLoaded uiPageChanged", this.resetStateVariables), this.on("uiNavigate", this.navigateUsingPushState), this.on("uiTeardown", this.doTeardown), this.on(document, "dataPageMutated", this.resetPageCache), this.on(document, "uiPromotedLinkClick", this.removePageFromCache), this.on(window, "beforeunload", this.destroyCurrentPageState)) : (this.on("uiSwiftLoaded", this.resetStateVariables), this.on("uiNavigate", this.navigateUsingRedirect))
        })
    }
    var component = require("core/component"),
        utils = require("core/utils"),
...
define("app/utils/with_keyboard_modality", ["module", "require", "exports", "app/utils/is_visible", "app/utils/is_enabled"], function(module, require, exports) {
    function withKeyboardModality() {
        this.defaultAttrs({
            ...
            c.some(function(a) {
                var b = $(a);
                if (isEnabled(b) && isVisible(b)) return d = a, !0
            });
            if (d) try {
                d.focus()
            } catch (e) {}
            ...
            a.prepend('<div class="' + this.attr.firstTabStopClass + '" tabindex="0"></div>'), a.append('<div class="' + this.attr.lastTabStopClass + '" tabindex="0"></div>')
    ...
    var isVisible = require("app/utils/is_visible"),
    ...
    ! function($) {
        ...
        a.prototype = {
            ...
            enter: function(a) {
                ...
                !b.options.delay || !b.options.delay.show ? b.show() : (clearTimeout(b.timeout), b.hoverState = "in", b.timeout = setTimeout(function() {
                    b.hoverState == "in" && b.show()
                }, b.determineShowDelay(b.options.delay.show)))
            },
            leave: function(a) {
                var b = $(a.currentTarget)[this.type](this._options).data(this.type);
                !b.options.delay || !b.options.delay.hide ? b.hide() : (clearTimeout(b.timeout), b.hoverState = "out", b.timeout = setTimeout(function() {
                    b.hoverState == "out" && b.hide()
                }, b.options.delay.hide))
            },
            hasIconOnlyLabel: function() {
                var a = this.$element.text().trim(),
                    b = !! this.$element.find("img").length,
                    c = function(a) {
                        return $(a).text().trim()
                    }, d = this.$element.find(".visuallyhidden, .u-isHiddenVisually").toArray().map(c).join("");
            ...
            shouldShow: function() {
                var a = !! this.$element.find(".visuallyhidden, .u-isHiddenVisually").length,
                    b = this.$element.text(),
                    c = b.trim() != this.getTitle();
                return c || !c && a
            },
            show: function() {
                var a, b, c, d, e, f, g;
                if (this.shouldShow() && this.hasContent() && this.enabled) {
                    clearTimeout(this.timeout), a = this.tip(), this.setContent(), this.options.animation && a.addClass("fade"), f = typeof this.options.placement == "function" ? this.options.placement.call(this, a[0], this.$element[0]) : this.options.placement, b = /in/.test(f), this.applyARIA(), a.remove().css({
                        top: 0,
                        left: 0,
                        display: "block"
            ...
            applyARIA: function() {
                var a = this.$element.text(),
                    b = this.$element.find("img").attr("alt"),
                    c = a + b,
                    d = c.trim() != this.getTitle();
            ...
            hide: function() {
                ...
                var a = this,
                    b = this.tip();
                clearTimeout(this.timeout), this.$element.removeAttr("aria-describedby"), b.removeClass("in"), $.support.transition && this.$tip.hasClass("fade") ? c() : b.remove()
            },
            fixTitle: function() {
                var a = this.$element;
...
define("app/ui/with_dropdown", ["module", "require", "exports", "core/compose", "app/utils/with_keyboard_modality", "$lib/bootstrap_tooltip.js"], function(module, require, exports) {
    function withDropdown() {
        compose.mixin(this, [withKeyboardModality]), this.defaultAttrs({
            ...
            if (this.activeEl) {
                a.preventDefault();
                try {
                    this.activeEl.focus(), this.activeEl = null
                } catch (a) {}
            }
            ...
            var b = a.target,
                c = $(b),
                d = this.$dropdown.find(this.attr.dropDownMenuSelector),
    ...
    function withDropdownMenu() {
        compose.mixin(this, [withDropdown]), this.defaultAttrs({
            ...
            this.$dropdown.find("li").attr("role", "presentation"), this.$dropdown.find(this.attr.menuItemSelector).each(function(a, b) {
                var c = $(b).find("a, button").eq(0),
                    d = !! c.length && isVisible(c) && isEnabled(c);
                d && c.attr({
                    role: "menuitem"
                })
            })
            ...
            if (!e || e && !e.length) e = b == "next" ? c.first() : c.last();
...
define("app/ui/language_dropdown", ["module", "require", "exports", "core/component", "app/ui/with_dropdownmenu"], function(module, require, exports) {
    var defineComponent = require("core/component"),
        withDropdownMenu = require("app/ui/with_dropdownmenu"),
...
define("app/ui/google", ["module", "require", "exports", "core/component"], function(module, require, exports) {
    function googleAnalytics() {
        this.defaultAttrs({
            ...
            window._gaq = window._gaq || [], window._gaq.push(["_setAccount", "UA-30775-6"], ["_trackPageview", this.getPageName()], ["_setDomainName", "twitter.com"]);
            ...
            window._gaq.push(["_trackPageview", this.getPageName()])
        }, this.getPageName = function() {
            var a = this.attr.loggedIn ? "user" : "anon",
                b = this.attr.pageName;
            return this.attr.loggedIn && b == "profile" && this.screenNameRE.test(location.pathname) && (b = "self"), "/" + [a, b, this.attr.sectionName].join("/")
        }, this.after("initialize", function() {
            this.screenNameRE = new RegExp("^/" + this.attr.screenName + "(/.*)?$"), this.on("uiSwiftLoaded", this.initGoogle), this.on("uiPageChanged", this.trackPageChange)
        })
    }
    var defineComponent = require("core/component"),
...
define("app/data/promoted_logger", ["module", "require", "exports", "core/component", "app/data/with_data"], function(module, require, exports) {
    function promotedLogger() {
        this.defaultAttrs({
            ...
            }), this.on("uiHasExpandedTweet", this.logPromotedTweetDetails), this.on("uiTweetDismissed", this.logPromotedTweetDismiss), this.on("uiDidShareViaEmailSuccess", this.logPromotedTweetShareViaEmail), this.on("uiUsersDisplayed", this.logPromotedUserImpression), this.on("uiDismissUserRecommendation", this.logPromotedUserDismiss), this.on("uiShowProfilePopup uiShowProfileNewWindow", this.logPromotedUserClick), this.on("uiCardUrlClick", this.logPromotedTweetCardUrlClick), this.on("uiEmbeddedMedia", this.logPromotedTweetEmbeddedMedia)
        })
    }
    var defineComponent = require("core/component"),
        withData = require("app/data/with_data"),
...
define("app/ui/message_drawer", ["module", "require", "exports", "core/component"], function(module, require, exports) {
    function messageDrawer() {
        this.defaultAttrs({
            ...
            topOffset: 46,
            hiddenClass: "hidden",
            modalOpenClass: "modal-enabled",
            $body: $("body")
        }), this.calculateFadeTimeout = function(a, b) {
            if (b != null) return b;
            var c = a.split(" ").length,
                d = c * 1e3 / 5 + 225;
            return d < this.attr.fadeTimeout ? this.attr.fadeTimeout : d
        }, this.showMessage = function(a, b, c) {
            var d = {
                top: this.attr.topOffset + $(this.attr.bannersSelector).height()
            };
            clearTimeout(this.messageTimeout), this.attr.$body.hasClass(this.attr.modalOpenClass) && (d.top = 0), this.$node.stop(), this.$node.removeClass(this.attr.hiddenClass), this.$node.animate(d, 300, function() {
                b || (this.messageTimeout = setTimeout(this.closeMessage.bind(this), this.calculateFadeTimeout(a, c)))
            ...
            a && a.preventDefault(), this.$node.animate({
                top: -40
            }, 300, function() {
            ...
            }), this.on(document, "uiBeforePageChanged uiHideMessage", this.closeMessage), this.on(document, "uiDialogOpened uiDialogClosed", this.repositionMessage), this.$node.hasClass(this.attr.hiddenClass) && this.closeMessage()
        })
    }
    var defineComponent = require("core/component"),
    ...
    function tooltips() {
        this.defaultAttrs({
            ...
            this.$node.tooltip({
                ...
                tooltipSelector: this.hide
            }), this.on(document, "uiBeforePageChanged uiShowProfilePopup uiDialogOpened uiGalleryOpened", this.hide)
        })
    }
    var defineComponent = require("core/component");
...
define("app/ui/keyboard_shortcuts", ["module", "require", "exports", "core/component", "core/utils"], function(module, require, exports) {
    function keyBoardShortcuts() {
        this.shortcutEvents = {
            ...
            f && e != this.lastKey ? (a.preventDefault(), typeof f == "string" ? b = f : (b = f.type, d = f.defaultFn, f.data && (g = utils.merge(g, f.data))), d && (c = {
                type: b,
                defaultBehavior: function() {
                    this[d](a, g)
                }
            }), this.trigger(a.target, c || b, g), this.lastKey = "") : (setTimeout(function() {
                this.lastKey = ""
            }.bind(this), 5e3), this.lastKey = e)
        }, this.isMetaKey = function(a) {
            return a.metaKey || a.ctrlKey || a.altKey
        }, this.ignore = function(a) {
            var b = a.target,
                c, d;
            return a.keyCode == 13 && (this.isMetaKey(a) ? c = !0 : d = !0), this.isMetaKey(a) && a.keyCode != 13 || this.isTextField(b) && !c && a.keyCode != 27 || d && this.isWhiteListedElement(b) || this.isFunctionKey(a)
            ...
            this.on("keydown", this.onKeyDown), this.attr.routes && utils.push(this.routes, this.attr.routes), this.createNavigationShortcuts()
        })
    }
    var defineComponent = require("core/component"),
        utils = require("core/utils"),
    ...
    function dynamicImageLoader() {
        this.defaultAttrs({
            ...
            this.select("placeholder").toArray().forEach(function(a) {
                var b = $("<img>").appendTo(a.parentNode),
                    c = b[0],
                    d = a.getAttribute("data-width"),
...
define("app/ui/aria_event_logger", ["module", "require", "exports", "core/component", "core/i18n", "core/utils"], function(module, require, exports) {
    function ariaEventLogger() {
        this.defaultAttrs({
            ...
            this.typeAheadResultsVisible && !! b.query && (b.numResults > 1 ? this.logMessage(_('{{numResults}} results displayed.', {
                numResults: b.numResults
            })) : this.logMessage(_('{{numResults}} result displayed.', {
                numResults: b.numResults
            })))
            ...
            }), this.on(document, "uiTypeaheadResultsShown", utils.debounce(this.logTypeAheadResultsVisible, this.attr.typeaheadDebounceInterval)), this.on(document, "uiShouldSpeakText", function(a, b) {
                this.logMessage(b.text)
...
deferred('$bower_components/jquery-placeholder/jquery.placeholder.js', function() {
    ...
    (function(a, b, $) {
        ...
        function m(a) {
            ...
            } else e.removeClass("placeholder"), k(e)
        }
        ...
        function p() {
            var a = this,
                c = $(a);
            if (!c.hasClass("placeholder")) return;
            try {
                if (b.selection) {
                    var d = a.createTextRange();
                    d.collapse(!0), d.moveEnd("character", 0), d.moveStart("character", 0), d.select()
                } else typeof a.selectionStart == "number" && (a.selectionStart = 0, a.selectionEnd = 0)
            } catch (e) {}
        }
        var c = "placeholder" in b.createElement("input"),
            d = "placeholder" in b.createElement("textarea"),
            e = $.fn,
            f = $.valHooks,
            g, h, i = {
...
define("app/boot/common", ["module", "require", "exports", "app/utils/auth_token", "app/boot/scribing", "app/ui/navigation", "app/data/navigation", "app/ui/language_dropdown", "app/ui/google", "app/ui/impression_cookies", "app/data/promoted_logger", "app/ui/message_drawer", "app/ui/tooltips", "app/ui/forms/screen_reader_label", "app/data/ttft_navigation", "app/utils/cookie", "app/utils/querystring", "app/data/user_info", "app/ui/banners/eu_cookie", "app/ui/keyboard_shortcuts", "app/ui/dynamic_image_loader", "app/ui/aria_event_logger", "app/data/scriber", "$bower_components/jquery-placeholder/jquery.placeholder.js"], function(module, require, exports) {
    ...
    module.exports = function(b) {
        ...
        b.pushState && e && NavigationUI.attachTo(document, {
        ...
        }), EuCookie.attachTo(".eu-cookie-notice"), b.loggedIn && (initialLoginTime = getLoginTime(), setInterval(verifySession, 1e4)), GoogleAnalytics.attachTo(document, {
            pageName: b.pageName,
            sectionName: b.sectionName,
    ...
    function ScrollbarWidth() {
        this.calculateScrollbarWidth = function() {
            ...
            var a = $('<div class="modal-measure-scrollbar"/>').prependTo($("body")),
                ...
                c = a.width() - b.width();
            a.remove(), $("head").append('<style id="scrollbar-width">        .compensate-for-scrollbar,        .modal-enabled,        .modal-enabled .global-nav-inner,        .profile-editing,        .profile-editing .global-nav-inner,        .gallery-enabled,        .grid-enabled,        .grid-enabled .global-nav-inner,        .gallery-enabled .global-nav-inner {          margin-right: ' + c + "px      }      </style>")
        }
    }
...
define("app/ui/with_dialog", ["module", "require", "exports", "core/compose", "app/ui/with_scrollbar_width", "app/utils/with_keyboard_modality", "app/utils/is_visible", "app/utils/is_enabled", "$lib/jquery.event.drag.js"], function(module, require, exports) {
    function withDialog() {
        compose.mixin(this, [withKeyboardModality, withScrollbarWidth]), this.defaultAttrs({
            ...
            if (!this.$dialog.hasClass(this.attr.dragabilityClass)) return;
            var a = this,
                b = {
                    relative: !0,
            ...
            if (a && b && !this.initiallyVisible && this.openState !== this.$dialogContainer.is(":visible")) throw new Error("Dialog markup and internal openState variable are out of sync.");
            ...
            this.isOpen() && b[a.keyCode] && this.close()
            ...
            this.removeFirstLastTabStop(this.$dialog), $(this.attr.modalContainerSelector + ":visible").length || $("body").removeClass(this.attr.modalEnabledClass), this.openState = !1, this.trigger(this.$dialog, {
...
define("app/ui/dialogs/signin_or_signup", ["module", "require", "exports", "core/component", "app/ui/with_dialog"], function(module, require, exports) {
...
define("app/ui/signup/stream_end_signup_module", ["module", "require", "exports", "core/component"], function(module, require, exports) {
    function streamEndSignupModule() {
        this.triggerSignupClick = function() {
            ...
            this.on("click", this.triggerSignupClick)
        })
    }
    var defineComponent = require("core/component");
    module.exports = defineComponent(streamEndSignupModule)
});
define("app/boot/logged_out", ["module", "require", "exports", "app/ui/dialogs/signin_or_signup", "app/ui/signup_call_out", "app/data/signup_click_scribe", "app/ui/signup/stream_end_signup_module"], function(module, require, exports) {
    var SigninOrSignupDialog = require("app/ui/dialogs/signin_or_signup"),
        ...
        StreamEndSignupModule = require("app/ui/signup/stream_end_signup_module");
    module.exports = function(b) {
        SigninOrSignupDialog.attachTo("#signin-or-signup-dialog", {
            eventData: {
                scribeContext: {
        ...
        }), SignupCallOut.attachTo(".js-signup-call-out form", {
            eventData: {
                scribeContext: {
...
define("app/utils/ttft", ["module", "require", "exports", "app/data/scribe_transport", "app/utils/params"], function(module, require, exports) {
    function scribeTTFTData(a, b) {
        if (!recorded && window.performance && a) {
            ...
            }, c.referrer = document.referrer, scribeTransport.send(c, "swift_time_to_first_tweet", !1);
    ...
    function b() {
        function e() {
            ...
            if (window.swiftActionQueue) {
                ...
                if (c.deciders)
                    if (c.deciders.scribeReducedActionQueue)
                        for (var f in e.buckets) $(document).trigger("scribe", {
                            scribeEvent: {
                                component: "reduced_action_queue",
                                action: f
                            },
                            scribeData: {
                                event_value: e.buckets[f]
                                    .length
                            }
                        });
            ...
            if (c.deciders && c.deciders.dynamicLoadMediaForward) {
                ...
                b.on("uiHasInjectedOldTimelineItems uiHasInjectedNewTimeline uiPageChanged", function() {
                    b.trigger("loadImages")
                })
            }
