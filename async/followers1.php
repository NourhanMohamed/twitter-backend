<?php 
	require_once "follower_fetch.php";
...
<div class="webcam-detect swf-container"></div>
  ...
  <li><a class="js-nav" href="/followers" data-element-term="follower_stats" data-nav="followers" data-is-compact="false">    Followers<strong title="0" class="js-mini-profile-stat"><?php echo"$followers"; ?></strong>
</a></li>
</ul>
...
<button type="button" class="btn primary-btn done">Done</button>
  ...
  <div class="content-header">
    <div class="header-inner">
      <h2 id="content-main-heading" class="js-timeline-title">Followers
      </h2>
...
<div class="content">
    <div class="stream-item-header">
      <a class="account-group js-user-profile-link" href="/',$follower['username'],'">
        ...
        <strong class="fullname js-action-profile-name">',$follower['username'],'</strong>
        <span>&rlm;</span>
        
          <span class="username js-action-profile-name">',$follower['name'],'</span>
            

      </a>
    </div>
      <p class="bio ">',$follower['avatar_url'],'</p>
